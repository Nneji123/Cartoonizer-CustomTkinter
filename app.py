...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        # if self.button_upload_image is not None:
        # self.display_image = customtkinter.CTkButton(master=self.frame_right, command=self.button_upload_image)
        # self.display_image.grid(row=1, column=0, columnspan=2, rowspan=4, pady=20, padx=20, sticky="nsew")
        
        # self.display_cartoon_image = customtkinter.CTkLabel(master=self.frame_right, command=self.inference_image)
        # self.display_cartoon_image.grid(row=2, column=3, columnspan=2, rowspan=4, pady=20, padx=20, sticky="nsew")
    ...
    def upload_image(self):
        ...
        self.display_image = customtkinter.CTkLabel(master=self.frame_right, image=myimage2)
        self.display_image.grid(row=1, column=0, columnspan=1, rowspan=1, pady=1, padx=1, sticky="nsew")
